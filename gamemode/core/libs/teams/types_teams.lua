---@alias TeamIdentifier string The string version of the team ID. example: TEAM_CITIZEN
---@alias TeamIndex number The index of the team that the identifier resolves to: TEAM_CITIZEN = 1
...
---@field id TeamIdentifier Team ID (this will be stored in the global Lua table as a reference to this team)
...
---@field savedNameGroup? string = default The name group to use for this team so we can have custom saved names for each team
